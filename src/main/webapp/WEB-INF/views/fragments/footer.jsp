  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header gradient-1">
        ...
        <h4 class="modal-title" id="myLargeModalLabel"><span class="fa fa-exclamation-triangle"></span> Alert</h4>
      </div>
      <div class="modal-body">
		<table id="datatable" class="table datatable-basic table-bordered table-striped table-hover">
        <thead>
            <tr>
            	<th></th>
                <th>Name</th>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header gradient-1">
        ...
        <h4 class="modal-title" id="myLargeModalLabel"><span class="fa fa-bell"></span> Reminder</h4>
      </div>
      <div class="modal-body">
        ...
      </div>
