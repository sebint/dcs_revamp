...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<spring:url value='resources/lib/dataTables/dataTables.checkboxes.css'/>">
	</head>
	<body class="sb-top sb-top-sm">
	     ...
	     <!-- Start: Topbar -->
	      <header id="topbar">
	        <div class="topbar-left">
	          <ol class="breadcrumb">
	            <li class="crumb-icon">
	              <s:a namespace="/" action="dashboard">
	        ...
	        <div class="topbar-right mt-5">
	          <div class="ib topbar-dropdown">
	            <label for="topbar-multiple" class="control-label pr10 fs20 text-muted">Dashboard</label>
	          </div>
	        </div>
	      </header>
	      <!-- End: Topbar -->
	  ...
	  <script type="text/javascript" src="<spring:url value='resources/lib/dataTables/dataTables.checkboxes.min.js'/>"></script>
