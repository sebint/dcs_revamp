	      ...
	      <header id="topbar">
	        <div class="topbar-left">
	          <ol class="breadcrumb">
	            ...
	            <li class="crumb-link">
	              <a href='<spring:url value="/assessment/nonproressive-validate"/>'>Non-Progressive Journal Validation</a>
	            </li>
	          </ol>
	        </div>
	        <div class="topbar-right mt-5">
	          <div class="ib topbar-dropdown">
	            <label for="topbar-multiple" class="control-label pr10 fs20 text-muted">Non-Progressive Journal Validation</label>
	          </div>
	        </div>
	      </header>
	      <!-- End: Topbar -->
